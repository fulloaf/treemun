...
[![PyPI Downloads](https://static.pepy.tech/personalized-badge/treemun-sim?period=total&units=INTERNATIONAL_SYSTEM&left_color=BLACK&right_color=GREEN&left_text=downloads)](https://pepy.tech/projects/treemun-sim)
...
\sum_{s\in S}\sum_{j\in J_s}F_{sj}x_{sj}\ge F_{\min},\\
&
H_{t+1}\ge (1-\delta)H_t && \forall t\in \lbrace 1,\ldots,H-1\rbrace,\\
&
x_{sj}\in \lbrace 0,1\rbrace,\quad H_t\ge 0
\rbrace .
\end{aligned}
$$
...
<p align="center">
  <img src="docs/images/epsilon_npv_with_carbon_thresholds.png" alt="Epsilon-constraint front: NPV maximization with carbon-stock-change thresholds" width="720">
</p>
